# Reference: http://pages.cs.wisc.edu/~remzi/OSTEP/dist-afs.pdf
...
# Test
# python andrew-file-system.py -C 2 -n 1 -s 12
# python andrew-file-system.py -C 2 -n 1 -s 12 -c
# python andrew-file-system.py -C 2 -n 1 -s 12 -c -d 1
# python andrew-file-system.py -C 2 -n 1 -s 12 -S 111000
# python andrew-file-system.py -s 12 -S 011100 -A oa1:r1:c1,oa1:w1:c1
# python andrew-file-system.py -s 12 -S 011100 -A oa1:r1:c1,oa1:w1:c1 -c -d 7
